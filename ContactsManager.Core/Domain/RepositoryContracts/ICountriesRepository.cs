...
namespace RepositoryContracts
{
  ...
  public interface ICountriesRepository
  {
    ...
    /// </summary>
    /// <returns>All countries from the Country table</returns>
    Task<List<Country>> GetAllCountries();

    /// <summary>
    /// Returns a country object based on the provided countryID; otherwise, returns null if no matching country is found
    /// </summary>
    ...
    /// <summary>
    /// Returns a country object based on the provided countryName; otherwise, returns null if no matching country is found
    /// </summary>
